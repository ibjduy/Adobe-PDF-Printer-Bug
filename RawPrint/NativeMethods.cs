...
namespace RawPrint
{
    ...
    [StructLayout(LayoutKind.Sequential, CharSet = CharSet.Unicode)]
    internal struct PRINTER_OPTIONS
    {
        public uint cbSize;
        public uint dwFlags;
    }
    ...
    internal class NativeMethods
    {
        ...
        [DllImport("winspool.drv", CharSet = CharSet.Unicode, SetLastError = true)]
        public static extern int OpenPrinter2W(string pPrinterName, out IntPtr phPrinter, ref PRINTER_DEFAULTS pDefault, ref PRINTER_OPTIONS pOption);
